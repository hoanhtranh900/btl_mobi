...
import com.mrash.instagramclone.Adapter.InboxDetailMessageListAdapter;
import com.mrash.instagramclone.Model.ChatMessage;
import com.mrash.instagramclone.Model.EchoModel;
...
public class MessageListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStompClient = Stomp.over(Stomp.ConnectionProvider.OKHTTP, "ws://192.168.0.101:8023/ig-clone/ws");
        resetSubscriptions();
        connectStomp();
        sendMessage();
